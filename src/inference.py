...
def main():
    ...
    parser.add_argument("--model-path", type=str, default=None, help="Path to loaded PEFT model (optional, uses default otherwise)")
    ...
    # For this simple script, it uses the initialized (untrained or default) weights 
    # unless we add logic to load specific saved weights.
